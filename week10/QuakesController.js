...
export default class QuakesController {
  ...
  constructor(parent, position = null) {
    ...
    // let's give ourselves the option of using a location 
    // other than the current location by passing it in.
    this.position = position || {
      lat: 0,
      lon: 0
    };
    // this is how our controller will know about the model 
    // and view...we add them right into the class as members.
  ...
  async getQuakesByRadius(radius = 100) {
    ...
    // Remove this later
    console.log('Here is the quakeList: ', quakeList);
